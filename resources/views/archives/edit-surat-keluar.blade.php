...
<div class="container">
    ...
    <form class="form-horizontal" method="POST" action="{{ url('/archive/surat-keluar').'/'.$archive->id }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
        ...
        <div class="form-group{{ $errors->has('nomor_surat') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="nomor_surat" type="text" class="form-control" name="nomor_surat" value="{{ $archive->nomor_surat }}">
